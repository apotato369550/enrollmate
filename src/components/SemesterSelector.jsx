  ...
  if (loading) {
    return (
      <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-4 shadow-lg border border-white/20">
        <div className="text-gray-600 font-jakarta">Loading semesters...</div>
      </div>
    );
  }
  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="bg-white/95 backdrop-blur-sm rounded-2xl px-6 py-4 shadow-lg border-2 border-enrollmate-green/30 hover:border-enrollmate-green hover:shadow-xl transition-all duration-300 w-full sm:w-auto min-w-[300px]"
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div className="text-left">
              <div className="text-xs font-jakarta font-medium text-gray-500">Active Semester</div>
              <div className="text-base font-jakarta font-bold text-gray-800">
      ...
      {isOpen && (
        <>
          ...
          {/* Menu */}
          <div className="absolute top-full mt-2 left-0 right-0 sm:left-auto sm:right-0 sm:min-w-[300px] bg-white rounded-2xl shadow-2xl border border-gray-200 z-50 max-h-96 overflow-y-auto">
            {/* Create New Button */}
            <button
              onClick={handleCreateNew}
              className="w-full px-6 py-4 text-left hover:bg-enrollmate-green/10 transition-colors border-b border-gray-200 flex items-center space-x-3"
            >
              ...
              <div>
                ...
                <div className="text-xs font-jakarta text-gray-500">Start a new semester</div>
              </div>
            </button>
            ...
            {semesters.length === 0 ? (
              <div className="px-6 py-8 text-center">
                <div className="text-gray-500 font-jakarta">No semesters yet</div>
                  ...
                  <div className="flex items-center space-x-3 flex-1">
                    ...
                    <div className="flex-1">
                      <div className={`font-jakarta font-bold ${
                        currentSemester?.id === semester.id ? 'text-enrollmate-green' : 'text-gray-800'
                      }`}>
                        {semester.name}
                      </div>
                      <div className="text-xs font-jakarta text-gray-500">
